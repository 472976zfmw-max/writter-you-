...
2. Add `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_ANON_KEY`, and `TEAM_EMAILS` as Vercel environment variables. Never expose the service-role key in browser code.
